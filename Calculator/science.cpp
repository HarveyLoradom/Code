...
void Science::on_Theme_triggered()
{
...
void Science::on_Background_triggered()
{
...
void Science::on_Font_triggered()
{
...
void Science::on_FontColor_triggered()
{
    QColorDialog colorDialog(this);
    QColor selectedColor = colorDialog.getColor(Qt::white, this);
    if (selectedColor.isValid()) {
...
void Science::on_FontBackgroundColor_triggered()
{
    QColorDialog colorDialog(this);
    QColor selectedColor = colorDialog.getColor(Qt::white, this);
    if (selectedColor.isValid()) {
